...
declare namespace L {
    ...
    export interface Layer extends Evented { //Layerdef
        addTo(map: Map): this;
        remove(): this;
    ...
    export interface Map extends Evented { //Mapdef
        ...
        fitBounds(bounds: LatLngBounds, options?: FitBoundsOptions): this; //Josh Church added '?' -6/20/17
        fitBounds(bounds: LatLngBoundsLiteral, options?: FitBoundsOptions): this; //Josh Church added '?' -6/20/17
